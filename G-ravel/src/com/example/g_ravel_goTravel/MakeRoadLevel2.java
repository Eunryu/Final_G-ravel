...
public class MakeRoadLevel2 extends Activity {
	...
	private class JsonParsor extends AsyncTask<String, Void, SimpleAdapter> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(MakeRoadLevel2.this);
		...
		protected SimpleAdapter doInBackground(String... params) {
			...
			SimpleAdapter adapter = new SimpleAdapter(MakeRoadLevel2.this,
		...
		protected void onPostExecute(SimpleAdapter adapter) {
			...
			pDialog.dismiss();
			Log.d("내려옴", "2");
			AreaList = (ListView) findViewById(R.id.lv_MakeRoadLevel2_Sarea);
			...
			try {
				AreaList.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Intent go_next = new Intent(MakeRoadLevel2.this,MakeRoadLevel3.class);
			...
			String test = data.getStringExtra("SET_AREA");

			TextView NameTitle = (TextView) findViewById(R.id.tv_MakeRoadLevel2_ChoiceArea);
